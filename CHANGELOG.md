...
- 播放详情页新增独立的静态暗色多色环境背景方案，保留现有模糊参数并在新方案下统一使用白色前景层级
- 暗色环境背景新增亮度、饱和度、色相间隔与可读性遮罩实时调节，参数独立保存且不影响现有模糊设置
- 歌曲详情页新增“重新扫描当前歌曲”，可提交当前媒体库歌曲所属导入规则的后台增量同步任务。
- 歌曲详情页新增媒体库缓存状态展示，可查看未缓存、已缓存、缓存已过期、缓存来源与本地缓存路径等只读信息。
- 新增媒体库歌曲详情独立页，「我的列表」中的本地 / 媒体库歌曲详情入口改为进入页面展示，并保留复制详情与歌手跳转能力
- 新增搜索页 LibraryMusicList 歌曲详情入口，本地 / 媒体库歌曲进入应用内详情页，在线音源仍保留外链详情
...
- 新增「我的列表」右侧快速滚动条，长列表可按住侧边热区拖动快速跳转

修复

- 修复综合搜索、单音源搜索和歌单内搜索中严格标题命中容易被模糊结果压后的问题，保留 `Sign` 等模糊召回结果但提升精确匹配优先级
- 修复「我的列表」右侧快速滚动把手只能移动少量距离、无法覆盖完整列表的问题
- 修复「我的列表」右侧快速滚动按钮仍会触发行内点击、无法按住把手跟手拖动的问题
...
- 修复「我的列表」右侧快速滚动条在深色主题下不明显、且缺少可拖动把手反馈的问题
- 修复「我的列表」右侧快速滚动把手拖动时因坐标反馈导致列表跳动的问题
- 修复年报导出与预览中部分榜单页高度过高、导致 P22 / P26 / P29 / L04A / L04B 无法稳定单页展示的问题，统一压缩页壳、榜单项与页脚摘要
- 修复年报 `P24` / `P31` / `L01` / `L03` 在真实曲库数据下会超出 844px 单页高度的问题，改为更紧凑的榜单卡片、覆盖率短卡与双栏结构展示
- 修复年报 `P12` - `P15` 四季最爱仍按时长选歌、`P30` 历年歌手榜不是近十年冠军视图、`P32` 页面顺序漂移，以及 `P21` 深夜页主题色回退的问题
- 修复年报 `P20` / `P21` 深夜页导出 PDF 时被统一浅底色污染、出现灰底或背景失真的问题，改为按页面使用独立深色导出底布并补齐深夜卡片兜底样式
...
- 修复年报 `L03` 曲库结构页语种与曲风条目过少、留白明显的问题，补齐更多展示项并压紧列表密度
- 修复年报 `P17` 在 BPM 覆盖不足时仍显示成一排 `BPM —` 的问题，改为回退展示每日播放次数与累计分钟
...
- 修复媒体来源后续增量更新 / 全量校验在旧快照已落入 `0` 时长或 `degraded` 占位元数据时仍持续复用旧数据，导致歌曲时长长期显示为 `00:00` 的问题
- 修复 WebDAV 媒体库在默认更新 / 全量校验时同步阶段禁用远端 metadata hydrate，导致旧的 `00:00` 时长无法重新补齐的问题，同时保持整批扫描继续走轻量路径
...
- 修复年报 `P24` / `P31` / `L01` / `L03` 在真实曲库数据下会超出 844px 单页高度的问题，改为更紧凑的榜单卡片、覆盖率短卡与双栏结构展示
- 修复年报 `P12` - `P15` 四季最爱仍按时长选歌、`P30` 历年歌手榜不是近十年冠军视图、`P32` 页面顺序漂移，以及 `P21` 深夜页主题色回退的问题
- 修复年报 `P11` 封面颜色页在真实色块数据下再次超出单页高度，以及 `P22` / `P24` / `P26` / `P29` / `P30` / `L01` / `L04` 榜单页铺满高度和布局风格不一致的问题，并给 `P12` - `P15` 补出按播放次数口径展示的冠军信息
...
- 在保留 Android `minSdkVersion 21` 与 `react-native-navigation@7.39.2` 的前提下，通过 npm overrides 将 RNN 传递依赖 `lodash` 固定到已修复版本，清空当前 `npm audit` 漏洞
...
## [0.26.09021030](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.09012158...v0.26.09021030) - 2026-09-02
...
## [0.26.09012158](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.09012125...v0.26.09012158) - 2026-09-01
...
## [0.26.09012125](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.08281630...v0.26.09012125) - 2026-09-01
...
## [0.26.08281630](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.08281546...v0.26.08281630) - 2026-08-28
...
## [0.26.08281546](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.08181354...v0.26.08281546) - 2026-08-28
...
## [0.26.08181354](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.08181006...v0.26.08181354) - 2026-08-18
...
## [0.26.08181006](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.08180805...v0.26.08181006) - 2026-08-18
...
## [0.26.08180805](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.08180715...v0.26.08180805) - 2026-08-18
...
## [0.26.08180715](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06240925...v0.26.08180715) - 2026-08-18
...
## [0.26.06240925](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06232256...v0.26.06240925) - 2026-06-24
...
## [0.26.06232256](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06212214...v0.26.06232256) - 2026-06-23
...
## [0.26.06212214](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06201840...v0.26.06212214) - 2026-06-21
...
## [0.26.06201840](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06182342...v0.26.06201840) - 2026-06-20
...
## [0.26.06182342](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06181402...v0.26.06182342) - 2026-06-18
...
## [0.26.06181402](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06151004...v0.26.06181402) - 2026-06-18
...
## [0.26.06151004](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06141019...v0.26.06151004) - 2026-06-15
...
## [0.26.06141019](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06121813...v0.26.06141019) - 2026-06-14
...
## [0.26.06121813](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06102043...v0.26.06121813) - 2026-06-12
...
## [0.26.06102043](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06101618...v0.26.06102043) - 2026-06-10
...
## [0.26.06101618](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06090804...v0.26.06101618) - 2026-06-10
...
## [0.26.06090804](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06082104...v0.26.06090804) - 2026-06-09
...
## [0.26.06082104](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06080939...v0.26.06082104) - 2026-06-08
...
## [0.26.06080939](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.06050031...v0.26.06080939) - 2026-06-08
...
## [0.26.06030816](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.05262143...v0.26.06030816) - 2026-06-03
...
## [0.26.05262143](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.05261654...v0.26.05262143) - 2026-05-26
...
## [0.26.05261654](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.05261452...v0.26.05261654) - 2026-05-26
...
## [0.26.05261452](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.05170237...v0.26.05261452) - 2026-05-26
...
## [0.26.05170237](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.05151611...v0.26.05170237) - 2026-05-17
...
## [0.26.05151611](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.05151326...v0.26.05151611) - 2026-05-15
...
## [0.26.05151326](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.05142253...v0.26.05151326) - 2026-05-15
...
## [0.26.05142253](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.05140035...v0.26.05142253) - 2026-05-14
...
## [0.26.05140035](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.05131228...v0.26.05140035) - 2026-05-14
...
## [0.26.05131228](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.05130809...v0.26.05131228) - 2026-05-13
...
## [0.26.05130809](https://github.com/ifwlzs/juMusic_lx/compare/v0.26.05130014...v0.26.05130809) - 2026-05-13
