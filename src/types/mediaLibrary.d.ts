declare namespace LX {
  namespace MediaLibrary {
    ...
    type PlaybackEntrySource = 'search' | 'list_click' | 'auto_next' | 'manual_next_prev' | 'restore' | 'deeplink' | 'temp_play' | 'leaderboard' | 'songlist_detail' | 'artist_detail' | 'album_detail' | 'media_library_artist_page' | 'unknown'
