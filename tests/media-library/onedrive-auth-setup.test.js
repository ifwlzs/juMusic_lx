...
test('android package and msal setup target io.ifwlzs.jumusic.lx debug and release registrations', () => {
  ...
  assert.match(buildGradle, /ONEDRIVE_RELEASE_REDIRECT_URI/)
  assert.match(buildGradle, /def oneDriveReleaseRedirectUri =/)
  ...
  assert.match(releaseWorkflow, /ONEDRIVE_RELEASE_REDIRECT_URI/)
  assert.match(betaWorkflow, /ONEDRIVE_RELEASE_REDIRECT_URI/)
