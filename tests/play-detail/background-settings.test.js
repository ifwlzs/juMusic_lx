...
test('play detail background exports shared defaults, auto-mask helpers, and a native hue bridge', () => {
  ...
  assert.match(configFile, /vignetteOverlayColor: buildRgba\(setting\.vignetteColor, vignetteOverlayOpacity\)/)
  assert.match(configFile, /vignetteTransparentColor: buildRgba\(setting\.vignetteColor, 0\)/)
  assert.doesNotMatch(configFile, /resolveVignetteBands = \(/)
  assert.doesNotMatch(configFile, /resolveLinearVignetteSlices = \(/)
  ...
  assert.match(layerFile, /LinearGradient/)
  assert.match(layerFile, /resolvedConfig\.vignetteOverlayColor/)
  assert.match(layerFile, /resolvedConfig\.vignetteTransparentColor/)
  ...
  assert.doesNotMatch(layerFile, /resolvedConfig\.linearVignetteSlices\.map/)
  assert.doesNotMatch(layerFile, /resolvedConfig\.vignetteBands\.flatMap/)
