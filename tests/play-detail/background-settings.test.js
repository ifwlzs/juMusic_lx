...
test('play detail background exports shared defaults, auto-mask helpers, and a native hue bridge', () => {
  ...
  assert.match(configFile, /export const resolveLinearVignetteSlices = \(/)
  ...
  assert.match(configFile, /linearVignetteSlices: resolveLinearVignetteSlices\(setting\)/)
  ...
  assert.match(layerFile, /resolvedConfig\.linearVignetteSlices\.map/)
