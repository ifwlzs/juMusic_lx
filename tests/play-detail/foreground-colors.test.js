...
test('play detail lyric current line uses lighter theme tones so it stands apart from non-active lines', () => {
  ...
  assert.match(verticalLyric, /playDetailPalette\.LYRIC_ACTIVE_ROMA_TEXT/)
  assert.match(verticalLyric, /playDetailPalette\.LYRIC_INACTIVE_TEXT/)
  assert.match(verticalLyric, /playDetailPalette\.LYRIC_TRANSLATION_TEXT/)
  assert.match(verticalLyric, /playDetailPalette\.LYRIC_ROMA_TEXT/)
  assert.match(verticalLyric, /useSettingValue\('player\.isShowLyricTranslation'\)/)
  assert.match(verticalLyric, /useSettingValue\('player\.isShowLyricRoma'\)/)
  ...
  assert.match(horizontalLyric, /playDetailPalette\.LYRIC_ACTIVE_ROMA_TEXT/)
  assert.match(horizontalLyric, /playDetailPalette\.LYRIC_INACTIVE_TEXT/)
  assert.match(horizontalLyric, /playDetailPalette\.LYRIC_TRANSLATION_TEXT/)
  assert.match(horizontalLyric, /playDetailPalette\.LYRIC_ROMA_TEXT/)
  assert.match(horizontalLyric, /useSettingValue\('player\.isShowLyricTranslation'\)/)
  assert.match(horizontalLyric, /useSettingValue\('player\.isShowLyricRoma'\)/)
