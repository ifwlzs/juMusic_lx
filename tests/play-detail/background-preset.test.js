...
test('page content rewires the emby variant to a mobile-safe shared background runtime instead of the old hard-band renderer', () => {
  ...
  assert.match(backgroundConfigFile, /export interface PlayDetailBackgroundLinearVignetteSlice/)
  assert.match(backgroundConfigFile, /blurLayers: PlayDetailBackgroundBlurLayer\[\]/)
  assert.match(backgroundConfigFile, /linearVignetteSlices: PlayDetailBackgroundLinearVignetteSlice\[\]/)
  assert.match(backgroundConfigFile, /export const resolveNativeBlurLayers =/)
  assert.match(backgroundConfigFile, /export const resolveLinearVignetteSlices =/)
  ...
  assert.match(backgroundLayerFile, /resolvedConfig\.linearVignetteSlices\.map/)
